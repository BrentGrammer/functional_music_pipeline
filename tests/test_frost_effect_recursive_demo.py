...
def test_frost_cluster_demo_grows_by_audible_events():
    ...
    assert len(flatten_voice_tones(score.voices[1])) == 1
    assert len(flatten_voice_tones(score.voices[2])) == 1
    seed_frequency = flatten_voice_tones(score.voices[0])[0].frequency
    ...
    source_event_frequencies = {flatten_voice_tones(voice)[0].frequency for voice in source_event_voices}
    first_event_frequencies = {flatten_voice_tones(voice)[1].frequency for voice in first_event_voices}
    second_event_frequencies = {flatten_voice_tones(voice)[1].frequency for voice in second_event_voices}
    third_event_frequencies = {flatten_voice_tones(voice)[1].frequency for voice in third_event_voices}
    fourth_event_frequencies = {flatten_voice_tones(voice)[1].frequency for voice in fourth_event_voices}
